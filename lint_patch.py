...
def format_and_patch(file_path):
    ...
    black_diff = run_command(["black", "--check", "--diff", "--exclude=.venv", file_path])
    if not black_diff:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Format Python files in a directory with Black, one at a time.")
